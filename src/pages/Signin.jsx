    ...
    <>
      ...
      <div className="fixed z-50 inset-0 flex items-center justify-center px-4">
        <div className="w-full max-w-[420px] bg-white rounded-lg p-10 relative font-['Roboto']">
          ...
          {/* GOOGLE */}
          <button className="w-full border border-gray-400 rounded-md py-2.5 flex items-center justify-center gap-3 mb-5 text-sm font-medium hover:bg-gray-50 hover:border-gray-300 transition">
            <FcGoogle size={18} />
          ...
          {/* OR */}
          <div className="text-center text-xs text-gray-400 mb-6 font-['Roboto']">
            OR
          </div>
