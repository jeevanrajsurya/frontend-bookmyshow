...
import e4 from "../assets/m4.avif"
import e5 from "../assets/m5.avif"
import e6 from "../assets/m6.avif"
import e7 from "../assets/m7.avif"
import e8 from "../assets/m8.avif"
import e9 from "../assets/m9.avif"
import e10 from "../assets/m10.avif"
...
const eventImages = [
  e1,e2,e3,e4,e5,e6,e7,e8,e9,e10,l1,l2,l3,l4,l5,l6,l7,l8
]
...
function EventsSection() {
  ...
  return (
    ...
    <div
      ...
      "
    >
      {filtersConfig.Languages.map((cat) => (
        <button
          key={cat}
          className="
            px-4 py-2
